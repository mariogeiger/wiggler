...
public struct M3: Equatable {
    ...
    public static func * (a: M3, v: V3) -> V3 {
        V3(a.m[0] * v.x + a.m[1] * v.y + a.m[2] * v.z,
    ...
    public func solve(_ b: V3) -> V3? {
        ...
        func replaced(_ col: Int) -> M3 {
            var r = self
            r[0, col] = b.x; r[1, col] = b.y; r[2, col] = b.z
            return r
        }
...
public struct RigidTransform: Equatable {
    ...
    public init(rotation: M3, translation: V3) { self.rotation = rotation; self.translation = translation }
